...
def step_impl(context):
    ...
    productdetailscreen.assert_text(
        *productdetailscreen.lbl_title_product_detail,
...
def step_impl(context):
    ...
    productdetailscreen = ProductDetailScreen(context)
    productdetailscreen.assert_text(
        *productdetailscreen.scroll_down_product_name,
...
def step_impl(context):
    ...
    productdetailscreen = ProductDetailScreen(context)
    productdetailscreen.assert_text(
        *productdetailscreen.scroll_down_product_price,
