...
def step_impl(context):
    ...
    shopping_cart_screen.assert_text(*shopping_cart_screen.title_tu_carrito, text=text_titulo_tu_carrito)
...
def step_impl(context):
    ...
    shopping_cart_screen = ShoppingCartScreen(context)
    shopping_cart_screen.assert_text(*shopping_cart_screen.lbl_nombre_producto, text=text_nombre_producto)
